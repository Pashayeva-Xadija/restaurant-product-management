...
public class CartController {
    ...
    @GetMapping
    public ResponseEntity<CartDto> getMyCart(org.springframework.security.core.Authentication a) {
        return ResponseEntity.ok(cartService.getMyCart(a.getName()));
    }

    @PostMapping("/items")
    public ResponseEntity<CartDto> addItem(@RequestBody AddToCartRequest req,
                                           org.springframework.security.core.Authentication a) {
        return ResponseEntity.ok(cartService.addItem(a.getName(), req));
    }

    @PutMapping("/items/{productId}")
    public ResponseEntity<CartDto> updateQuantity(@PathVariable Long productId, @RequestParam int qty,
                                                  org.springframework.security.core.Authentication a) {
    ...
    @DeleteMapping
    public ResponseEntity<Void> clear(org.springframework.security.core.Authentication a) {
